...
var StorageMarshaler = (function (_super) {
    __extends(StorageMarshaler, _super);
    function StorageMarshaler(control, storage) {
        var _this = _super.call(this, control) || this;
        _this.storage = storage;
        return _this;
    }
    StorageMarshaler.prototype.close = function (streamId) {
        this.storage.close(streamId);
    };
    StorageMarshaler.prototype.fileDialog = function (mode, dialogOptions, fileOptions) {
        return this.storage.fileDialog(mode, dialogOptions, fileOptions);
    };
    StorageMarshaler.prototype.getFileList = function (path, persistence, index, count) {
        return this.storage.getFileList(path, persistence, index, count);
    };
    StorageMarshaler.prototype.openFile = function (path, options) {
        return this.storage.openFile(path, options);
    };
    StorageMarshaler.prototype.seek = function (streamId, offset, origin) {
        return this.storage.seek(streamId, offset, origin);
    };
    StorageMarshaler.prototype.readBinary = function (streamId, count) {
        return this.storage.readBinary(streamId, count);
    };
    StorageMarshaler.prototype.readText = function (streamId, count) {
        return this.storage.readText(streamId, count);
    };
    StorageMarshaler.prototype.writeBinary = function (streamId, data, offset, count) {
        return this.storage.writeBinary(streamId, data, offset, count);
    };
    StorageMarshaler.prototype.writeText = function (streamId, data, offset, count) {
        return this.storage.writeText(streamId, data, offset, count);
    };
    StorageMarshaler.prototype.onmessage = function (source, eventArges) {
        return _super.prototype.onMessage.call(this, source, eventArges);
    };
    return StorageMarshaler;
}(marshaler_1.SynchronousJsonPortMarshaler));
exports.StorageMarshaler = StorageMarshaler;

//# sourceMappingURL=../messaging/storageMarshaler.js.map
// SIG // Begin signature block
// SIG // MIIasAYJKoZIhvcNAQcCoIIaoTCCGp0CAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFF3QqiP1hgdS
// SIG // JBzLc8fQu1r0WTnLoIIVgzCCBMMwggOroAMCAQICEzMA
...
// SIG // KwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU0taGjRQc
// SIG // KFOuJz0O9lvYzOAyVTYwUgYKKwYBBAGCNwIBDDFEMEKg
// SIG // KIAmAHMAdABvAHIAYQBnAGUATQBhAHIAcwBoAGEAbABl
// SIG // AHIALgBqAHOhFoAUaHR0cDovL21pY3Jvc29mdC5jb20w
// SIG // DQYJKoZIhvcNAQEBBQAEggEAG3x+oG8HqR68L2EKn71x
// SIG // u5FwOePTxDQPEH97zJQb0RO96QvXyJrjWumP36IsSBGZ
// SIG // lZTuDMudUg9WJT9qW1+52y5AAYPRuYS8CI9epdd/OYjH
// SIG // b9ayi1k7uq/fDUxruyhCkCetlMgW+vE+8So6KWfjnSlf
// SIG // Az0387ayE1guRQIRbyaaYSawrBbxmEvo13OuNoLrx6Qq
// SIG // 0WtvD/kGOuwxEX0yGoVnjxfzqLGXzHme8NI2B3Swh+9P
// SIG // Ov/3LaBRtcUQHAIfeVLeZJcTvT579VcBZsopJIHf80TK
// SIG // nHEP5dG7vr1Cu75kHAAW7xvQJ7sB3pfuTrQUKF7TWv2d
// SIG // aMPZCJtjmEiKLqGCAigwggIkBgkqhkiG9w0BCQYxggIV
...
// SIG // EzMAAADMy7gT611yLUUAAAAAAMwwCQYFKw4DAhoFAKBd
// SIG // MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZI
// SIG // hvcNAQkFMQ8XDTE3MDYxMjIyNTQ1NlowIwYJKoZIhvcN
// SIG // AQkEMRYEFDFzWQUXbenRzdMWwIZmMobQ6c86MA0GCSqG
// SIG // SIb3DQEBBQUABIIBAAQJC6yKrCx3cQIofAJrUyxLRokC
// SIG // 1r7RkCqJ6SU9ZbJLziEVKaHMW20w9K7oKqVQnXnNbNzF
// SIG // +Ur0tZniIskFiBmc9DzGkXT3k1iRRY4scMcUc24NBRjP
// SIG // y8S1E3GTBYMPlTOxAOWJJAgGAQ5mtQkkIqU+l/hNmi8v
// SIG // pzqaM5k+yMCd9+UhldTLIi4i1BLCaTXEL8uHoBMUUrJI
// SIG // KyxlHxFPPG6Gu8B7SiQzVNi5xtpo1o8zqMHKGycWYDYO
// SIG // PCLnIRoK3o66VXaeJ6xP6+aRDCjXalnS8RhFZNkXKoqa
// SIG // 7XrE8uyNPVlbf/amDGoxV2O0kZTAbf7DZ9NUDxjYAYWe
// SIG // hNGb6es=
