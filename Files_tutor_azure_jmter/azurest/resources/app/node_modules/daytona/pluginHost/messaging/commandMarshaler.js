...
var CommandsMarshaler = (function (_super) {
    __extends(CommandsMarshaler, _super);
    function CommandsMarshaler(control, menuAliases, commandAliases, commandsProvider) {
        var _this = _super.call(this, control) || this;
        _this.menuAliases = menuAliases;
        _this.commandAliases = commandAliases;
        _this.commandsProvider = commandsProvider;
        return _this;
    }
    CommandsMarshaler.prototype.setCommandsStates = function (states) {
        return this.commandsProvider.setCommandsStates(states);
    };
    CommandsMarshaler.prototype.showContextMenu = function (menuName, xPosition, yPosition) {
        return this.commandsProvider.showContextMenu(menuName, xPosition, yPosition);
    };
    CommandsMarshaler.prototype.fireCommandExecuted = function (commandName) {
        this.fireEvent('commandexec', {
            CommandName: commandName
        });
    };
    CommandsMarshaler.prototype.initializeState = function () {
        this.fireEvent('commandsinitialized', {
            menuAliases: this.menuAliases,
            commandAliases: this.commandAliases,
        });
    };
    return CommandsMarshaler;
}(marshaler_1.SynchronousJsonPortMarshaler));
exports.CommandsMarshaler = CommandsMarshaler;

//# sourceMappingURL=../messaging/commandMarshaler.js.map
// SIG // Begin signature block
// SIG // MIIasAYJKoZIhvcNAQcCoIIaoTCCGp0CAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFBTVHgy5Ra3l
// SIG // P16aRWvUEAjiLAOLoIIVgzCCBMMwggOroAMCAQICEzMA
...
// SIG // KwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUaQ+apXc1
// SIG // xTj4GZKRQy/IBhV4XicwUgYKKwYBBAGCNwIBDDFEMEKg
// SIG // KIAmAGMAbwBtAG0AYQBuAGQATQBhAHIAcwBoAGEAbABl
// SIG // AHIALgBqAHOhFoAUaHR0cDovL21pY3Jvc29mdC5jb20w
// SIG // DQYJKoZIhvcNAQEBBQAEggEAgELEgeth60l3vno8bzUW
// SIG // izvv+Mk1FiB4pH2c1NiT16TVQutL2XvgQOuiOgdZetS3
// SIG // ZESMovThp4e1ESGo81oE6pRKx2rijIrCI+mm+AXv/F9u
// SIG // mFCGzd5n0vzMyqVVstZHDOF18cIl3l9P4orItAOjf2cV
// SIG // Am0bsTAIuS+uOd95nnX+9WefviG7t/i/aPRB0WNy7534
// SIG // /kOUDl+0ufLc2T3nEp8fs0+yIgTKx27eTW7q8BXtt3uU
// SIG // /+7e/H4pAmNo6QuRVqSahTtdZ9u5sgYgDRUArDWnPo0k
// SIG // 1Y0VAg7zodGpCH4G/euX4SWM7aE5N9kGgt2sHB1dDFtu
// SIG // pjSUcaRBIj/+PqGCAigwggIkBgkqhkiG9w0BCQYxggIV
...
// SIG // AQkEMRYEFERGAGfUTcCK/keIY86AqjHjK1adMA0GCSqG
// SIG // SIb3DQEBBQUABIIBADPh7Oab68X5mBA+hTfX7UuQkPEB
// SIG // i0K8PyD3FaBjc18oR3JqkIaBsrqajV76d37DAlyMo5hl
// SIG // UJanMZXcd6gsc9xR48/yxbH8/lGL6ImBmt3jZrhmPqdX
// SIG // FBSqr+ceAhVSykpjsyrjxxcKDEyJV+zI2gGYmMLUfNj1
// SIG // DQAU/SyEjN63fnGSwdstWSjJ4mHWA++NtG/n8moOYtml
// SIG // phGyrfM2+dK0rVh6rM4XUpq+Gcz0ndUvQaHk2jmLoJqz
// SIG // vtOoEnN78waDNltd22VUXJuhef1m8minf/PTHTreHW/s
// SIG // WJguHZCBXMObhj9JvVMBlDGXKe3lHRSUIMKf0SBRp3cD
// SIG // HMBuSHY=
