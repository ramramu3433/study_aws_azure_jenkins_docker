...
var marshaler_1 = require("./marshaler");
var ContextMenuMarshaler = (function (_super) {
    __extends(ContextMenuMarshaler, _super);
    function ContextMenuMarshaler(control, contextMenuProvider) {
        var _this = _super.call(this, control) || this;
        _this.contextMenuProvider = contextMenuProvider;
        return _this;
    }
    ContextMenuMarshaler.prototype.callback = function (id) {
        return this.contextMenuProvider.callback(id);
    };
    ContextMenuMarshaler.prototype.dismissAll = function () {
        return this.contextMenuProvider.dismissAll();
    };
    ContextMenuMarshaler.prototype.dismissCurrent = function (ignoreDismissForRoot) {
        return this.contextMenuProvider.dismissCurrent(ignoreDismissForRoot);
    };
    ContextMenuMarshaler.prototype.dismissSubmenus = function (currentCoordinates) {
        return this.contextMenuProvider.dismissSubmenus(currentCoordinates);
    };
    ContextMenuMarshaler.prototype.contentready = function () {
        return this.contextMenuProvider.contentready();
    };
    ContextMenuMarshaler.prototype.show = function (id, ariaLabel, contextMenuHtml, positionInfo) {
        return this.contextMenuProvider.show(id, ariaLabel, contextMenuHtml, positionInfo);
    };
    ContextMenuMarshaler.prototype.contextMenuDismissed = function () {
        this.fireEvent('contextmenudismissed', {});
    };
    return ContextMenuMarshaler;
}(marshaler_1.SynchronousJsonPortMarshaler));
exports.ContextMenuMarshaler = ContextMenuMarshaler;

//# sourceMappingURL=../messaging/contextMenuMarshaler.js.map
// SIG // Begin signature block
// SIG // MIIauAYJKoZIhvcNAQcCoIIaqTCCGqUCAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFM3oWO2dyia9
// SIG // +7aLV63dexCtTDIwoIIVgzCCBMMwggOroAMCAQICEzMA
...
// SIG // KwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUEQ1wjbgg
// SIG // Mgtj6VT9egsARYTqSiEwWgYKKwYBBAGCNwIBDDFMMEqg
// SIG // MIAuAGMAbwBuAHQAZQB4AHQATQBlAG4AdQBNAGEAcgBz
// SIG // AGgAYQBsAGUAcgAuAGoAc6EWgBRodHRwOi8vbWljcm9z
// SIG // b2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAU5nquozKk
// SIG // t0E/EJEBOror1lpCxlPw/gkjn/5BcQqxISv5yZ24maHh
// SIG // Kdr2KXerpPP7UiIG1+WHARp1bBvgNhg0HCocR42C76rz
// SIG // 4uOTSgJj17IYYCCtS/njX9CqafVz9TJS4ITPhvdLFotj
// SIG // z1ga1SXPUpq1TBNlsgsXrsSE9LaVO1dgLpIF9U+M8qlc
// SIG // 54eIM6aRdjM5B2H+ReQJQsHM9aPkYOm0RZDY3yusX2qt
// SIG // cSXwIeebnMD7Rlk480mJ2o2k3m9TVwY9Om1lPZnxMRWs
// SIG // v4KY7vtkHdsw1sSkstVcheqz4Di/1k7TMks/eATDFlDc
// SIG // YSQ22NVh0RiyzV6h5CLdIOhqoYICKDCCAiQGCSqGSIb3
// SIG // DQEJBjGCAhUwggIRAgEBMIGOMHcxCzAJBgNVBAYTAlVT
// SIG // MRMwEQYDVQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdS
// SIG // ZWRtb25kMR4wHAYDVQQKExVNaWNyb3NvZnQgQ29ycG9y
// SIG // YXRpb24xITAfBgNVBAMTGE1pY3Jvc29mdCBUaW1lLVN0
// SIG // YW1wIFBDQQITMwAAAMZ4gDYBdRppcgAAAAAAxjAJBgUr
// SIG // DgMCGgUAoF0wGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEH
// SIG // ATAcBgkqhkiG9w0BCQUxDxcNMTcwNjEyMjI1NDU2WjAj
// SIG // BgkqhkiG9w0BCQQxFgQUSKt9EbOPXLGDhu/GNLaIF0Wk
// SIG // nPkwDQYJKoZIhvcNAQEFBQAEggEABvAjF06EDSnNBaPb
// SIG // lzXZ+6aCfIuCXRxTVriN/JOTtHKms5nDUFKp90qkZJuZ
// SIG // RUDWf418t5IpRUdyQ562nEqGhDrcq7hvDsqGeVbT/ZoK
// SIG // B/OUdgMqVXHoBci6DRcCwvQ16mUdpDJFkeeItl3s8k3g
// SIG // niqzHKVZ+2wiGMwDqEwcdEReXGJPUnJRfd+M2oh1RFOU
// SIG // 0ErZP3AH4FeZqyQuS6MZ4o7vowSERAxDnSo/5XLQgaiE
// SIG // HyjUTW2QS8t3p+4Pq4fJHhP7TEI+FWaj6RbiCNH7cUMN
// SIG // EnMRMh3UX0lncY63M6Bz2ZWMSkbqnxQXOdGveQ0iKqsM
// SIG // zXY8sV+sfQDGqYMlTg==
