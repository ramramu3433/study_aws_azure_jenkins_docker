...
var themeEventArgs_1 = require("../common/themeEventArgs");
var event_1 = require("../common/event");
var Path = require("path");
var ThemeProvider = (function (_super) {
    __extends(ThemeProvider, _super);
    function ThemeProvider(fileProvider, themeDirectory, currentTheme) {
        ...
        _this.themeDirectory = themeDirectory + '/';
        return _this;
    }
    ThemeProvider.prototype.getPluginCss = function () {
        var pluginCssPath = Path.join(Path.resolve(__dirname, "..", "..", "theme"), "plugin.css");
        return this.fileProvider.getFileContents(pluginCssPath);
    };
    ThemeProvider.prototype.getThemeMap = function () {
        ...
        return this.fileProvider.getFileContents(currentThemeFilePath).then(function (contents) {
            if (!contents) {
                return "";
            }
    ...
    ThemeProvider.prototype.updateTheme = function (newTheme) {
        if (!newTheme || newTheme.length === 0) {
            throw new Error("New Theme cannot be empty");
        }
        this.currentTheme = newTheme;
        this.dispatchEvent('themechanged', new themeEventArgs_1.ThemeEventArgs(newTheme));
    };
    return ThemeProvider;
}(event_1.EventTarget));
exports.ThemeProvider = ThemeProvider;

//# sourceMappingURL=../xShell/themeProvider.js.map
// SIG // Begin signature block
// SIG // MIIaqgYJKoZIhvcNAQcCoIIamzCCGpcCAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFL8GJrOZ8sCZ
// SIG // ygi+dqT9KKsPsbdAoIIVgzCCBMMwggOroAMCAQICEzMA
...
// SIG // KwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUm0fSXOA/
// SIG // XC/LraHwgnshrR+cxFAwTAYKKwYBBAGCNwIBDDE+MDyg
// SIG // IoAgAHQAaABlAG0AZQBQAHIAbwB2AGkAZABlAHIALgBq
// SIG // AHOhFoAUaHR0cDovL21pY3Jvc29mdC5jb20wDQYJKoZI
// SIG // hvcNAQEBBQAEggEAYt92WIXunt6OeLo9F2uvme6rSI2C
// SIG // kFKcdzqRVu/pH1cB7e4G9U/pwsNGvIS0ABgMC7PutheH
// SIG // bmtrXeP0saEe1NiaikjLLcunfH0ztbp/gBybqn/canZX
// SIG // GAlUIqGhpzMdjWKFA5LnN2M5+a/LzytBzKxuCMQr9dto
// SIG // 7SottZdjRDKZi4+j9xExnLPcp5at9DVS+bQZ9K5XHkGu
// SIG // mu1AHnHdyKzSvta4F7B9Wv0Pzaek6izAltDuhUs5Jruo
// SIG // QU6oG2Pssocl7d8x//UA9fAs78m8plH4oguc6wzI/saX
// SIG // qlhUpm2aroTelgbE/4cgxe2JMGM86Hs37mGtVjF3euSp
// SIG // qsw5YKGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIB
...
// SIG // MQ8XDTE3MDYxMjIyNTUwMVowIwYJKoZIhvcNAQkEMRYE
// SIG // FCUv7HQd6yKS3NqVNsWeJUiXTAXkMA0GCSqGSIb3DQEB
// SIG // BQUABIIBAJi9WNGOryP0yybherUBoCaoF+fP0pMlhh9k
// SIG // DM6BzsClyG5AArFrAAHm6xskgjGS3ZgCrXbFCHJ+VAqK
// SIG // vYz+u/ZL3jtfCzciJZoVhE7nzN6oEGyazayF8Hhn0TT8
// SIG // TOGoQfx4oRIihrT/jrRdxW0hcEWNpEFtH/qWy2k3yxOA
// SIG // bMfF3A7Op/+NRpfkIyD9O0J54owxab2M6UHuPSHm02MV
// SIG // ZiKr0I+rE4PyE6NvbdXLPlXndAz3+9ShFDEST1H1Evv2
// SIG // +qdMw2HCnXG9nEiYw/vWOEEPpT8i+EQb17ATsvF2loSV
// SIG // dzT+5LW2FhwS26Gub3XxmOXtM4jQwXtYtvZjdetaiIg=
