...
var DaytonaHost = require("../daytonaHost");
var fileProvider_1 = require("./fileProvider");
var logProvider_1 = require("./logProvider");
var resourcesProvider_1 = require("./resourcesProvider");
var themeProvider_1 = require("./themeProvider");
var storageProvider_1 = require("./storageProvider");
var ElectronHost = (function (_super) {
    __extends(ElectronHost, _super);
    function ElectronHost(parent, manifestFile, themeDirectory, parameters) {
        ...
        var culture = (navigator.userLanguage || navigator.language);
        _this = _super.call(this, 'Microsoft Visual Studio Native Client', parent, manifestFile, pluginBaseDirectory, baseThemeId, culture, themeDirectory, parameters) || this;
        return _this;
    }
    ElectronHost.prototype.close = function () {
        _super.prototype.close.call(this);
    };
    ElectronHost.prototype.pluginToPageCoords = function (pluginX, pluginY) {
        return { x: pluginX + this.control.iframe.offsetLeft, y: pluginY + this.control.iframe.offsetTop };
    };
    ElectronHost.prototype.updateTheme = function (newTheme) {
        if (!newTheme || newTheme.length === 0) {
            throw new Error("Theme name cannot be empty");
        }
        this.themeProvider.updateTheme(newTheme);
    };
    ElectronHost.prototype.getFileProvider = function () {
        return new fileProvider_1.FileProvider();
    };
    ElectronHost.prototype.getLogProvider = function () {
        return new logProvider_1.LogProvider();
    };
    ElectronHost.prototype.getResourcesProvider = function () {
        return new resourcesProvider_1.ResourcesProvider(this.fileProvider, this.defaultCulture);
    };
    ElectronHost.prototype.getThemeProvider = function () {
        return new themeProvider_1.ThemeProvider(this.fileProvider, this.themeBaseDirectory, this.defaultTheme);
    };
    ElectronHost.prototype.getStorageProvider = function () {
        return new storageProvider_1.StorageProvider();
    };
    return ElectronHost;
}(DaytonaHost.DaytonaHost));
exports.ElectronHost = ElectronHost;

//# sourceMappingURL=../xShell/electronDaytonaHost.js.map
// SIG // Begin signature block
// SIG // MIIatgYJKoZIhvcNAQcCoIIapzCCGqMCAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFNGbIv20IuCg
// SIG // FxjuU27g5uhFPtBHoIIVgzCCBMMwggOroAMCAQICEzMA
...
// SIG // 2/e/gX4Wz4L/FfRSAMKk8YMSMIIE7TCCA9WgAwIBAgIT
...
// SIG // KwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUtPD38hQt
// SIG // uK3iX6CQ4PSREDfvy5MwWAYKKwYBBAGCNwIBDDFKMEig
// SIG // LoAsAGUAbABlAGMAdAByAG8AbgBEAGEAeQB0AG8AbgBh
// SIG // AEgAbwBzAHQALgBqAHOhFoAUaHR0cDovL21pY3Jvc29m
// SIG // dC5jb20wDQYJKoZIhvcNAQEBBQAEggEATfvzHl5oanUY
// SIG // 3lYNVbX5k6O3dJECrcZvB4zOmVAArr1NOAUnEziEf1gf
// SIG // ttvk5BmirxliHt9dDzOnxuN+R8vEbIsUghzPm2/m9dsm
// SIG // m9fJK4yOQ1Fe9empOsWnvPT+WqXVcQexoK0XMhaiV5JT
// SIG // ZkOLxXGy58h1eYM0E9gHDwH6ZXMMq+xep/3BCLSPByBV
// SIG // zuNf939IOM0S65ZhECiMitSBNufG5ymwWR0CMX4VMgMN
// SIG // EnGRhYrwX9TXm00Yi1NywXd+N66gMf7yIPWOqXddbm6z
// SIG // hlUpIgOagjx6l+Yr7hZHQr2BkxWbo+P9C0oVwbuMZE01
// SIG // fSn0ZOX+sJSnAprk2ARSPaGCAigwggIkBgkqhkiG9w0B
// SIG // CQYxggIVMIICEQIBATCBjjB3MQswCQYDVQQGEwJVUzET
// SIG // MBEGA1UECBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVk
// SIG // bW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0
// SIG // aW9uMSEwHwYDVQQDExhNaWNyb3NvZnQgVGltZS1TdGFt
// SIG // cCBQQ0ECEzMAAADJZE0W2xp9sxUAAAAAAMkwCQYFKw4D
// SIG // AhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEw
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE3MDYxMjIyNTUwMVowIwYJ
// SIG // KoZIhvcNAQkEMRYEFH0WxlB0Q6HibzXdxc+0OTzQQEKJ
// SIG // MA0GCSqGSIb3DQEBBQUABIIBACJDRH55itfITR827Ylh
// SIG // +OlePC2hf5LCb39LE+hgtvgkPVw1lfryVAuwdLZk+05P
// SIG // B2Xva1vW4eSJIgkn0M/dNIhEEOR8hDOhac/q0Hh4r4+t
// SIG // qIazYs49XpAS6ckcmGoBt72cBExCMqbPJHsSRfO9bTx6
// SIG // 5koUxHwQqEgav1KKtAKrcpkIt3MH8DrQ9C633mqdyBqo
// SIG // zE3hyhi6n2hwex99JvBDVCeIud+Dzse8/8YN41zGvXtc
// SIG // Dg2VBvqiUDpl6NMmxtnr1QyNUBk4Vw5+7LGBi4zFrjXZ
// SIG // TaBef3ADjAkxUXuZ5A5hV7Si6PXJnjg7kbpcHTDOII81
// SIG // w0zDqLLDQSP+EMA=
