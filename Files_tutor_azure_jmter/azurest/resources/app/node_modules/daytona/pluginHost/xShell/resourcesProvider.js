...
var cultureEventArgs_1 = require("../common/cultureEventArgs");
var Path = require("path");
var ResourcesProvider = (function (_super) {
    __extends(ResourcesProvider, _super);
    function ResourcesProvider(fileProvider, defaultCulture) {
        var _this = _super.call(this) || this;
        _this.fileProvider = fileProvider;
        _this.currentCulture = defaultCulture;
        return _this;
    }
    ResourcesProvider.prototype.loadResources = function (directoryPath, filePath) {
        var _this = this;
        ...
        return this.fileProvider.getFileContents(resourceFileName).then(function (contents) {
            return JSON.parse(contents);
        }, function (error) {
            resourceFileName = Path.join(directoryPath, normalizedFilePath + '.resjson');
            return _this.fileProvider.getFileContents(resourceFileName).then(function (contents) {
                return JSON.parse(contents);
            });
        });
    };
    ResourcesProvider.prototype.updateCulture = function (newCulture) {
        this.currentCulture = newCulture;
        this.dispatchEvent('culturechanged', new cultureEventArgs_1.CultureEventArgs(newCulture));
    };
    ResourcesProvider.prototype.getDefaultErrorMessage = function () {
        return ResourcesProvider.genericError;
    };
    return ResourcesProvider;
}(event_1.EventTarget));
ResourcesProvider.genericError = 'An error has occurred.  Please try the operation again.\r\nYou can search for the error online: ';
exports.ResourcesProvider = ResourcesProvider;

//# sourceMappingURL=../xShell/resourcesProvider.js.map
// SIG // Begin signature block
// SIG // MIIasgYJKoZIhvcNAQcCoIIaozCCGp8CAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFPLUMVcBfDt4
// SIG // 1fvl6oG37VvuMEmSoIIVgzCCBMMwggOroAMCAQICEzMA
...
// SIG // KwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUY7/6HVq4
// SIG // fWeu1CqeYZLh0toUCOIwVAYKKwYBBAGCNwIBDDFGMESg
// SIG // KoAoAHIAZQBzAG8AdQByAGMAZQBzAFAAcgBvAHYAaQBk
// SIG // AGUAcgAuAGoAc6EWgBRodHRwOi8vbWljcm9zb2Z0LmNv
// SIG // bTANBgkqhkiG9w0BAQEFAASCAQAHXvi+JCe+KcEg+3du
// SIG // F6SYGDs14DYFZD4JjrRNLgENwi3OPSSI+Zr6TwPOOXGP
// SIG // Jt4SvhpTv2xiVNB4N4Z1gBO/2sfrvRhGHzC6RvzBGP2V
// SIG // pRi7qg+IiOKJZaqqbqt9+J9SsH3UiYou/SuS45Q5FpGN
// SIG // LEPrHrYQuqQYVRJBh4NzfPSOQi9RR/55Q7JqmPxuxTR3
// SIG // 5nzq5wVliL9S0QzUiR1JWFozhZ/8/wR3KsBg/g4QPp5F
// SIG // 9rfm62UQi9T2tySWDxuI1zPo2H7ym77IwXWt+KBoFNTj
// SIG // yfIRSFoBWnylTlhxi/gyEgYpYBgNPwHCmvBUU8Ag7CwT
// SIG // oLkFZGxbCIyB4P8+oYICKDCCAiQGCSqGSIb3DQEJBjGC
// SIG // AhUwggIRAgEBMIGOMHcxCzAJBgNVBAYTAlVTMRMwEQYD
// SIG // VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25k
// SIG // MR4wHAYDVQQKExVNaWNyb3NvZnQgQ29ycG9yYXRpb24x
// SIG // ITAfBgNVBAMTGE1pY3Jvc29mdCBUaW1lLVN0YW1wIFBD
// SIG // QQITMwAAAMZ4gDYBdRppcgAAAAAAxjAJBgUrDgMCGgUA
// SIG // oF0wGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkq
// SIG // hkiG9w0BCQUxDxcNMTcwNjEyMjI1NTAxWjAjBgkqhkiG
// SIG // 9w0BCQQxFgQU8t96mKjhyINJYHhwQuYPYYGbq5AwDQYJ
// SIG // KoZIhvcNAQEFBQAEggEAVEfE+FZ6uAS5CLwl0i/DAPqP
// SIG // Ka05RZSIjcZ01YCSFB5hhAMF/xbUAKkqZao5ky1oaO5A
// SIG // lgT/cQChYNY4mFjtwHTKC4DpFVhjw4ZECRG8QpX/arph
// SIG // ovbg0NYxX2cMlbZHS1zRDyE6oV/iqU0pAgFMeYQjhKGg
// SIG // QexYbf9GKxKSm0EuksleMGuHZ3QeMGU6ajwx8PTyt7/+
// SIG // WmR+O+GuVVNh+O8JSdHqx/Ajp9fjJ1WgmkgBz3Cuz/cQ
// SIG // MIm/V/OK2PjApn4WuJJy0JCsbk8O7ERs7qjI48XJL6kg
// SIG // LuHonvFjpfM4aotDMkSyTJUrMbCm7SZTelQbNUgNp3gJ
// SIG // g/+SYgfP8Q==
