//import DialogsCommon = require("StorageExplorer/Dialogs/DialogsCommon");
define(["require", "exports"], function (require, exports) {
    ...
    */
    function IsValidLanguageIndependentIdentifier(value) {
    ...
    function IsValidTypeNameOrIdentifier(value, isTypeName) {
        ...
        for (var i = 0; i < value.length; i++) {
            ...
            if (UnicodeCategory.Lu.test(ch) ||
            ...
            else if (UnicodeCategory.Mn.test(ch) ||
                ...
                if (!isTypeName) {
                    ...
                    var ref = { nextMustBeStartChar: nextMustBeStartChar };
