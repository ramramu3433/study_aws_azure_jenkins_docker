...
define(["require", "exports", "knockout", "underscore", "../Constants", "../QueryBuilder/QueryViewModel", "datatables"], function (require, exports, ko, _, Constants, QueryViewModel_1) {
    "use strict";
    ...
    var DataTableViewModel = (function () {
        ...
        DataTableViewModel.prototype.renderPage = function (renderCallBack, draw, startIndex, pageSize, oSettings, postRenderTasks) {
            ...
            if (!this.queryTablesTab.queryViewModel()) {
                this.queryTablesTab.queryViewModel(new QueryViewModel_1.default(this.queryTablesTab));
            }
            var render = {
                draw: draw,
                aaData: renderData,
