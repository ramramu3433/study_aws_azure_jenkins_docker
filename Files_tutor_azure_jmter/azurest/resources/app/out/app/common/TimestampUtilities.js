...
var Timestamps = (function () {
    ...
    Timestamps.tryChangeTimestampTimeZone = function (koTimestamp, toUTC) {
        if (koTimestamp) {
            ...
            if (currentDateString) {
                if (toUTC) {
                    newDateString = Timestamps.trimDateStringSuffix(Timestamps.utcFromLocalDateString(currentDateString));
                }
                else {
                    newDateString = Timestamps.trimDateStringSuffix(Timestamps.localFromUtcDateString(currentDateString));
                }
    ...
    Timestamps.isDateString = function (dateString) {
        var success = false;
        if (dateString) {
